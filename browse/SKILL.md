...
version: 1.1.0
description: |
  Fast headless browser for QA testing and site dogfooding. Use when you need to test a feature, verify a deployment, dogfood a user flow, or file a bug with evidence.
triggers:
  - browse a page
  - headless browser
