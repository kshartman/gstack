...
version: 1.0.0
description: |
  Set up gbrain for this coding agent: install the CLI, initialize a local PGLite or Supabase brain, register MCP, capture per-remote trust policy. Use when: "setup gbrain", "connect gbrain", "start...
triggers:
  - setup gbrain
  - install gbrain
  - connect gbrain
