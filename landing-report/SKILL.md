...
version: 0.1.0
description: |
  Read-only queue dashboard for workspace-aware ship. Use when asked to "landing report", "what's in the queue", "show me open PRs", or "which version do I claim next".
triggers:
  - landing report
  - version queue
  - ship queue
