...
version: 1.0.0
description: |
  Import cookies from your real Chromium browser into the headless browse session. Use when asked to "import cookies", "login to the site", or "authenticate the browser".
triggers:
