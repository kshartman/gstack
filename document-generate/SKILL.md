...
version: 1.0.0
description: |
  Generate missing documentation from scratch for a feature, module, or entire project. Use when asked to "write docs", "generate documentation", "document this feature", "create a tutorial", or...
allowed-tools:
  - Bash
  - Read
  - Write
