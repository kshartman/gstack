...
version: 1.0.0
description: |
  Self-tuning question sensitivity + developer psychographic for gstack (v1: observational). Use when asked to "tune questions", "stop asking me that", "too many questions", "show my profile", "what...
triggers:
  - tune questions
  - stop asking me that
  - too many questions
