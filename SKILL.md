...
version: 1.1.0
description: |
  Fast headless browser for QA testing and site dogfooding. Use when asked to open or test a site, verify a deployment, dogfood a user flow, or file a bug with screenshots.
allowed-tools:
  - Bash
  - Read
  - AskUserQuestion
