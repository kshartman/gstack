...
- If `UPGRADE_MODE` is `manual`: tell the user "gstack **v{new}** is available (you're on v{old}). To update, pull and review in your dev repo, then run `./release`." Do NOT offer to auto-upgrade or read the upgrade skill.
