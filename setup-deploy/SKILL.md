...
version: 1.0.0
description: |
  Configure deployment settings for /land-and-deploy. Use when: "setup deploy", "configure deployment", "set up land-and-deploy", "how do I deploy with gstack", "add deploy config".
triggers:
  - configure deploy
  - setup deployment
  - set deploy platform
