...
version: 1.0.0
description: |
  Codify the most recent successful /scrape flow into a permanent browser-skill on disk. Use when asked to "skillify", "codify", "save this scrape", or "make this permanent".
allowed-tools:
  - Bash
  - Read
  - Write
