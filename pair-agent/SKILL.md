...
version: 0.1.0
description: |
  Pair a remote AI agent with your browser. Use when asked to "pair agent", "connect agent", "share browser", "remote browser", "let another agent use my browser", or "give browser access".
triggers:
  - pair with agent
