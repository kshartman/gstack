...
version: 0.2.0
description: |
  Launch GStack Browser — AI-controlled Chromium with the sidebar extension baked in. Use when asked to "open gstack browser", "launch browser", "connect chrome", "open chrome", "real browser",...
triggers:
  - open gstack browser
  - launch chromium
  - show me the browser
