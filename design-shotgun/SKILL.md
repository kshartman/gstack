...
version: 1.0.0
description: |
  Design shotgun: generate multiple AI design variants, open a comparison board, collect structured feedback, and iterate. Use when: "explore designs", "show me options", "design variants", "visual...
triggers:
  ...
  - or "i don't like how this looks
allowed-tools:
  - Bash
  - Read
  - Glob
